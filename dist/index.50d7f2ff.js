...
const img = _index.createNode('img', {
    src: 'https://images.clipartlogo.com/files/images/44/441434/bananas-icon-clip-art_p.jpg',
    alt: 'Banana Image'
});
const a = _index.createNode('a', {
    href: 'https://google.com'
}, img);
const h2 = _index.createNode('h2', {}, 'BANANA!!!');
const div = _index.createNode('div', {}, h2);
const mainDiv = _index.createNode('div', {}, a, div);
_index.init(mainDiv, '#app');
...
function $53ffd25df6034fb9$var$workWithDom(node) {
    ...
    if (node.effectTag === $faefaad95e5fcca0$export$ea8d20c92e194fd2.create && node.dom) node.parent.dom.appendChild(node.dom);
...
function $53ffd25df6034fb9$var$updateChildrenNode(node) {
    ...
    while(index < children.length || committedNode){
        ...
        if (!committedNode && childNode) newNode = {
            type: childNode.type,
            effectTag: $faefaad95e5fcca0$export$ea8d20c92e194fd2.create,
            props: childNode.props,
            children: childNode.children,
